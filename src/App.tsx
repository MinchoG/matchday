...
type Fixture = { id: string; date: string; time: string; kickoff?: string | null; competition: string; home: string; away: string; venue: string; heat: number; note: string; homeBadge?: string | null; awayBadge?: string | null; tv?: { channel: string; source: string; sourceUrl: string } | null; homeScore: number | null; awayScore: number | null; status: string };
