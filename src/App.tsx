...
type Fixture = { id: string; date: string; time: string; competition: string; home: string; away: string; venue: string; heat: number; note: string; homeBadge?: string | null; awayBadge?: string | null; homeScore: number | null; awayScore: number | null; status: string };
...
export default function App() {
  ...
  return (
    <main className="app">
      <header className="site-header"><a className="brand" href="https://mincho.dev"><span className="brand-mark">M</span><span>mincho.dev / matchday</span></a><div className="live-pill"><span /> {loading ? 'Loading matchday…' : updated ? `Updated ${updated}` : 'Daily fixture archive'}</div></header>
      <section className="page-shell">
        ...
        <p className="data-note">TheSportsDB free data · Updated daily · Europe/Sofia time</p>
      </section>
    </main>
  );
}
